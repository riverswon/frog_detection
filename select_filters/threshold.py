...
# save accuracy threshold start[Hz] stop[Hz] features... [filter_sample][4+fg+no]
...
def experiment2_set_threshold(num):
	with open('select_filters/frog_data/experiment2/experiment2_train_x_'+str(num)+'.pkl', 'rb') as filters_pkl:
	...
	with open('select_filters/frog_data/experiment2/experiment2_train_threshold_'+str(num)+'.pkl', 'wb') as threshold_data_pkl:
		pickle.dump(threshold_data , threshold_data_pkl, protocol=2)
	del threshold_data
	print('finished:'+str(num))

def experiment1_set_threshold(num):
	with open('select_filters/frog_data/experiment1/experiment1_train_x_'+str(num)+'.pkl', 'rb') as filters_pkl:
		filters_features = pickle.load(filters_pkl)
	sample2 = load_excel_np('audio_data/cross_validation_sample2.xlsx')
	sample1 = load_excel_np('audio_data/cross_validation_sample1.xlsx')
	sample = np.zeros(2, dtype=int)
	...
	threshold_data = set_threshold(filters_features, sample)
	with open('select_filters/frog_data/experiment1/experiment1_train_threshold_'+str(num)+'.pkl', 'wb') as threshold_data_pkl:
		pickle.dump(threshold_data , threshold_data_pkl, protocol=2)
	del threshold_data
	print('finished:'+str(num))
...
#non frog2
def experiment3_set_threshold(num):
	with open('select_filters/frog_data/experiment3/experiment3_train_x_'+str(num)+'.pkl', 'rb') as filters_pkl:
		filters_features = pickle.load(filters_pkl)
	sample2 = load_excel_np('audio_data/cross_validation_sample2.xlsx')
	sample1 = load_excel_np('audio_data/cross_validation_sample1.xlsx')
	sample = np.zeros(2, dtype=int)
	for i in range(5):
		if i == num:
			continue
		sample[0] += sample1[i][0]
		sample[1] = sample[1] + sample1[i][1] + sample2[i][1]
	threshold_data = set_threshold(filters_features, sample)
	with open('select_filters/frog_data/experiment3/experiment3_train_threshold_'+str(num)+'.pkl', 'wb') as threshold_data_pkl:
		pickle.dump(threshold_data , threshold_data_pkl, protocol=2)
	del threshold_data
	print('finished:'+str(num))
...
if __name__ == '__main__':
	for i in range(5):
		experiment3_set_threshold(i)
	for i in range(5):
		experiment4_set_threshold(i)
